...
/* Full-width waveform SVG separator between sections */
...
export function SectionWaveDivider({ flip = false, fromColor = '#FAF9F6', toColor = '#F0EDE5' }: SectionWaveDividerProps) {
  return (
    <div className={`relative w-full h-8 md:h-10 overflow-hidden ${flip ? 'rotate-180' : ''}`}>
