...
function AnimatedWaves() {
  return (
    <svg className="absolute top-1/2 left-0 right-0 w-full h-56 -translate-y-1/2 pointer-events-none" viewBox="0 0 1440 240" preserveAspectRatio="none" aria-hidden="true">
      <motion.path
...
export function Hero() {
  ...
  return (
    <section id="accueil" className="relative overflow-hidden" aria-label="Accueil">
      ...
      <div className="min-h-[92vh] flex items-center justify-center relative z-10 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-3 mb-6 px-6 py-2.5 border border-white/[0.12] rounded-full bg-white/[0.05] backdrop-blur-sm">
          ...
          <motion.button
            ...
            className="group inline-flex items-center gap-3 px-8 py-4 bg-white text-night rounded-full hover:bg-white/95 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(255,255,255,0.25)]"
          >
      ...
      <div className="h-20 bg-gradient-to-b from-night to-ivory relative z-10" aria-hidden="true" />
    </section>
  )
}
