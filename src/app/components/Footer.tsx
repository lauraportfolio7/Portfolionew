...
export function Footer() {
  return (
    <footer className="relative overflow-hidden">
      <div className="h-6 bg-gradient-to-b from-[#F6F9FD] to-[#1C2340]" />

      <div className="bg-[#1C2340] text-white/80">
        <div className="max-w-6xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-5">
            <div className="text-center md:text-left">
              <p className="text-xl mb-0.5 text-white" style={{ fontFamily: "'Playfair Display', serif" }}>
                C.L
              </p>
            ...
            <div className="flex items-end gap-[2px]">
              {[2, 4, 3, 8, 5, 12, 6, 14, 6, 10, 4, 7, 3, 5, 8, 4, 12, 5, 10, 4, 6, 3, 4, 2].map((h, i) => (
                <motion.div
                  key={i}
                  className="w-[1.5px] rounded-full bg-white/12"
                  initial={{ height: 0 }}
